...
class MLEventdetails extends StatelessWidget {
  const MLEventdetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final todo = ModalRoute.of(context)!.settings.arguments as SuggestedEvents;
    return Scaffold(
